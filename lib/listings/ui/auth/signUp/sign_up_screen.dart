import 'dart:io';
import 'favorite_bathrooms.dart';
import 'dart:math';
...
class _SignUpState extends State<SignUpScreen> {
  ...
  String? firstName, lastName, email, password, confirmPassword, favBathroom;
  AutovalidateMode _validate = AutovalidateMode.disabled;
  bool acceptEULA = true;

  // Random bathroom hint generator
  String getRandomBathroomHint() {
    final random = Random();
    int randomIndex = random.nextInt(favoriteBathrooms.length);
    return favoriteBathrooms[randomIndex];
  }
